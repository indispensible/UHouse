...
// Baidu Maps: http://dev.baidu.com/wiki/map/x086le/index.php?title=%E9%A6%96%E9%A1%B5
...
KindEditor.plugin('flash', function(K) {
	var self = this, name = 'flash', lang = self.lang(name + '.'),
		...
		uploadJson = K.undef(self.uploadJson, self.basePath + 'php/x086le/upload_json.php');
	self.plugin.flash = {
		edit : function() {
			var html = [
