...
<div class="container body">
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <form class="form-horizontal form-label-left" novalidate id="updateforlvgang">

                      <div class="item form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="community_city">小区所在城市</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="community_city" class="form-control col-md-7 col-xs-12" name="community_city" required="required" type="" placeholder="上海市" value="<?php echo ($vo["community_city"]); ?>" >
                        </div>
                      </div>
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="community_name" class="form-control col-md-7 col-xs-12" name="community_name" required="required" type="text" placeholder="远光小区" value="<?php echo ($vo["community_name"]); ?>">
                        </div>
                      </div>
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="community_location" class="form-control col-md-7 col-xs-12" name="community_location" required="required" type="text" placeholder="上海市杨浦区国定路777号" value="<?php echo ($vo["community_location"]); ?>">
                        </div>
                      </div>
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="house_location" class="form-control col-md-7 col-xs-12" name="house_location" required="required" type="text" placeholder="6栋6楼606室" value="<?php echo ($vo["house_location"]); ?>">
                        </div>
                      </div>
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="type" class="form-control col-md-7 col-xs-12" name="type" required="required" type="text" placeholder="两室一厅" value="<?php echo ($vo["type"]); ?>">
                        </div>
                      </div>
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="area" class="form-control col-md-7 col-xs-12" name="area" required="required" type="text" placeholder="42平米" value="<?php echo ($vo["area"]); ?>">
                        </div>
                      </div>
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="price" class="form-control col-md-7 col-xs-12" name="price" required="required" type="text" placeholder="4200元" value="<?php echo ($vo["price"]); ?>">
                        </div>
                      </div>
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <textarea id="detail" class="form-control col-md-7 col-xs-12" name="detail"  type="text" placeholder="可不填" ><?php echo ($vo["detail"]); ?></textarea>
                        </div>
                      </div>
                      ...
                      <div class="item form-group" >
                        ...
                        <div class="col-sm-5" id="col-lvgang-1">
                          ...
                          <!--上传图片1-->
                          <img style="display: none" id="upload_org_code_img1" src="<?php echo ($vo["image1"]); ?>" width="180" height="180">
                          <input id="file_lvgang1" name="image1" type="hidden" multiple="true" value="">
                          <!--上传图片2-->
                          <img style="display: none" id="upload_org_code_img2" src="<?php echo ($vo["image2"]); ?>" width="180" height="180">
                          <input id="file_lvgang2" name="image2" type="hidden" multiple="true" value="">
                          <!--上传图片3-->
                          <img style="display: none" id="upload_org_code_img3" src="<?php echo ($vo["image3"]); ?>" width="180" height="180">
                      ...
                      <div class="item form-group" id="lvganglaile3">
                        ...
                        <div class="col-sm-5" id="col-lvgang-2">
                          ...
                          <!--上传图片4-->
                          <img style="display: none" id="upload_org_code_img4" src="<?php echo ($vo["image4"]); ?>" width="180" height="180">
                          <input id="file_lvgang4" name="image4" type="hidden" multiple="true" value="">
                          <!--上传图片5-->
                          <img style="display: none" id="upload_org_code_img5" src="<?php echo ($vo["image5"]); ?>" width="180" height="180">
                          <input id="file_lvgang5" name="image5" type="hidden" multiple="true" value="">
                          <!--上传图片6-->
                          <img style="display: none" id="upload_org_code_img6" src="<?php echo ($vo["image6"]); ?>" width="180" height="180">
                      ...
                      <div class="form-group">
                        <div class="col-md-6 col-md-offset-3">
                          <button type="button" class="btn btn-primary" onclick="changeHref()">取消</button>
                          <button id="updateByLvGang" type="button" class="btn btn-success">确认</button>
                        </div>
                      </div>
                    </form>
                  </div>
    ...
    <script>
        var SCOPE={
            'save_url':'/uhouse/admin.php?c=landlord&a=checkId',
