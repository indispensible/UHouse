...
<div class="container body">
                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <table id="datatable" class="table table-striped table-bordered">
                      ...
                      <?php if(is_array($lvgang)): $i = 0; $__LIST__ = $lvgang;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tbody>
                        <tr>
                          <td><?php echo ($vo["rent_condo_district"]); ?></td>
                          <td><?php echo ($vo["rent_housing"]); ?></td>
                          <td><?php echo ($vo["rent_condo_loc"]); ?></td>
                          <td><?php echo ($vo["rent_condo_area"]); ?></td>
                          <td><?php echo ($vo["rent_condo_price"]); ?></td>
                          <td><a href="<?php echo ($vo["rent_condo_url"]); ?>" target="_blank">更多详情！</a></td>
                          <td>
                            <a  class="renter-delete"   attr-message="删除" value="<?php echo ($vo["rent_condo_id"]); ?>" >
                              <span class="glyphicon glyphicon-remove-circle" aria-hidden="true" value="<?php echo ($vo["rent_condo_id"]); ?>" onclick="deleteRenter(this)"></span>
                            </a>
                          </td>
                        </tr>
    ...
    <script src="/uhouse/Public/js/admin/lvgang.js"></script>
