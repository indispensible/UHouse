...
return array(
    ...
    'TMPL_PARSE_STRING' =>  array(
        // __PUBLIC__/x086le/upload  -->  /x086le/Public/x086le/upload -->http://appname-public.stor.sinaapp.com/x086le/upload
        '/x086le/Public/x086le/upload'    =>  $st->getUrl('public','upload')
    ),
    'LOG_TYPE'          =>  'Sae',
